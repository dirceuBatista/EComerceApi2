...
public class OrderCreateValidator : AbstractValidator<InputOrderCreate>
{
    public OrderCreateValidator(AppDbContext context)
    {
        ...
        RuleFor(x => x.OrderItems)
            ...
            RuleForEach(x => x.OrderItems)
                .SetValidator(new OrderItemCreateValidator(context));
    }
}
